...
def save_to_excel(data, filename='silpo_kava_vlasnogo_obsmazhennia.xlsx'):
...
def fetch_and_save_data_api(category, filename='silpo_kava_vlasnogo_obsmazhennia.xlsx'):
...
# Виклик функції
fetch_and_save_data_api('kava-vlasnogo-obsmazhennia-5113')
