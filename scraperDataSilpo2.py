...
with webdriver.Chrome(options=options) as driver:
    ...
    while True:
        ...
        try:
            # Знаходження кнопки наступної сторінки
            # next_button = driver.find_element(By.CLASS_NAME, "pagination-item.ng-star-inserted")
            next_button = driver.find_element(By.CSS_SELECTOR, "a.pagination-item.pagination-item--next")
            next_button.click()
