...
def fetch_product_data_api(page=1, limit=40):
    ...
    headers = {
        ...
        "Referer": "https://varus.ua/kava-zernova~typ-kavy_melena",
    }
    params = {
...
def save_to_excel(data, filename='varus_kava_melena_main.xlsx'):
...
def fetch_and_save_data_api(filename='varus_kava_melena_main.xlsx', limit=40):
