...
def fetch_product_data_api(page=1, limit=30):
    ...
    headers = {
        ...
        "Referer": "https://novus.zakaz.ua/uk/categories/coffee-ground/",
        "x-chain": "novus",
...
def save_to_excel(data, filename='novus_kava_melena.xlsx'):
...
def fetch_and_save_data_api(filename='novus_kava_melena.xlsx', limit=30):
