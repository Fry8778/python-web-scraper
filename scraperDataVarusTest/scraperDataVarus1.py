...
def fetch_product_data_api(offset=0):
    ...
    params = {
        "_source_include": "name,price,special_price_discount,stock.qty,weight",
        "from": offset,
...
def save_to_excel(data, filename='varus_products1.xlsx'):
...
def fetch_and_save_data_api(filename='varus_products1.xlsx'):
