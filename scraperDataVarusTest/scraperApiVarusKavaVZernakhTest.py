...
def save_to_excel(data, filename='scraper_api_Varus_kava_v_zernakh_test.xlsx'):
...
def fetch_and_save_data_api(category, filename='scraper_api_Varus_kava_v_zernakh_test.xlsx', size=40):
